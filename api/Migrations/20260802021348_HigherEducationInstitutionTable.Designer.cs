...
namespace api.Migrations
{
    ...
    [Migration("20260802021348_HigherEducationInstitutionTable")]
    partial class HigherEducationInstitutionTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.HigherEducationInstitution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("AcademicCharacter")
                        .IsRequired()
                        .HasMaxLength(100)
                    ...
                    b.Property<bool>("IsHighQualityAccredited")
                    ...
                    b.ToTable("HigherEducationInstitution", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.PostalCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EastLimit")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("NeighborhoodsContainedInPostalCode")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("RuralAreasContainedInPostalCode")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");

                    b.Property<string>("SouthLimit")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
            ...
            modelBuilder.Entity("api.Models.RequestMetricRollup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("LargestRequestPath")
                        .HasMaxLength(2048)
                    ...
                    b.Property<long>("TotalResponseBytes")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("RequestMetricRollup", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.TraditionalFairAndFestival", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TraditionalFairAndFestival", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.UrbanCenter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("UrbanCenter", (string)null);
                });
            ...
            modelBuilder.Entity("api.Models.HigherEducationInstitution", b =>
                {
                    b.HasOne("api.Models.City", "City")
                        .WithMany("HigherEducationInstitutions")
                        .HasForeignKey("CityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("api.Models.City", b =>
                {
                    ...
                    b.Navigation("HigherEducationInstitutions");
